  ...
  <tbody>
    <tr>
      	...
      	<td>
			...
			<td>
				<a href="record_delete.com?rollno=<%=rec.getRollno()%>">Delete</a>
			</td>
			<td>
				<a href="record_update_form.com?rollno=<%=rec.getRollno()%>">Update</a>
			</td>
		</tr>
		<% } %>
		<tr >
			<td colspan="8" align="center">
				<button type="button" class="btn btn-light btn-sm " style="width:150px"><a href="home.jsp" >Back</a></button>
			</td>
			<td>
